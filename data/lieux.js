...
window.LIEUX_DATA = [
  ...
  {
    "nom": "Cascade Cachée d'Ambalabe",
    "ville": "Toamasina",
    "description": "Cascade secrète à l'écart des circuits touristiques, nichée au cœur de la forêt tropicale. Bassin naturel d'eau cristalline entouré de fougères arborescentes géantes. Eau fraîche et revigorante, idéale pour baignade tranquille. Spot confidentiel apprécié des locaux pour sa sérénité absolue.",
    "tags": [
      "toamasina",
      "spots",
      "budget_1",
    ...
    "type": "Cascade",
    "duree": "2-3h",
    "conseil": "Suivez un guide local pour trouver le chemin. Apportez pique-nique et maillot de bain.",
    "acces": "35 km au sud de Toamasina, sentier de 20min de marche depuis la route",
    "horaires": "Accès libre, meilleur tôt le matin",
    "id": 701,
    "image": "images/placeholder-spot.jpg",
    "siteWeb": "https://www.google.com/maps/search/Cascade+Cachée+d'Ambalabe+Toamasina"
  },
  {
    "nom": "Plage Secrète de Sahanivotry",
    "ville": "Toamasina",
    "description": "Petite plage isolée accessible uniquement par sentier côtier ou pirogue. Sable blanc immaculé, cocotiers penchés, lagon turquoise peu profond. Quasi déserte même le week-end. Parfait pour ceux cherchant solitude et authenticité loin des foules touristiques.",
    "tags": [
      "toamasina",
      "spots",
      "budget_1",
    ...
    "type": "Plage Secrète",
    "duree": "Demi-journée",
    "conseil": "Prenez pirogue depuis village de pêcheurs. Apportez tout (eau, nourriture, parasol).",
    "acces": "50 km au nord, pirogue depuis le village côtier (négocier prix)",
    "horaires": "Accessible marée basse uniquement",
    "id": 702,
    "image": "images/placeholder-spot.jpg",
    "siteWeb": "https://www.google.com/maps/search/Plage+Secrète+de+Sahanivotry+Toamasina"
  },
  {
    "nom": "Point de Vue Panoramique Antetezantsena",
    "ville": "Toamasina",
    "description": "Promontoire rocheux offrant vue spectaculaire à 360° sur l'océan Indien, le Canal des Pangalanes et forêts tropicales. Coucher de soleil époustouflant. Spot photo exceptionnel peu connu. Courte randonnée nécessaire mais récompense visuelle garantie.",
    "tags": [
      "toamasina",
      "spots",
      "budget_1",
    ...
    "type": "Point de Vue",
    "duree": "2h",
    "conseil": "Arrivez 1h avant coucher du soleil (vers 17h). Chaussures de marche recommandées.",
    "acces": "25 km de Toamasina, parking puis 30min de marche",
    "horaires": "Accès libre, éviter saison pluies",
    "id": 703,
    "image": "images/placeholder-spot.jpg",
    "siteWeb": "https://www.google.com/maps/search/Point+de+Vue+Panoramique+Antetezantsena+Toamasina"
  },
  {
    "nom": "Grotte des Pirates d'Andovoranto",
    "ville": "Toamasina",
    "description": "Grotte marine historique où pirates se cachaient au 17ème siècle. Stalactites, stalagmites, bassins d'eau douce souterrains. Légendes de trésors enfouis persistent. Exploration guidée obligatoire pour sécurité. Expérience aventure mystérieuse et authentique.",
    "tags": [
      "toamasina",
      "spots",
      "budget_2",
    ...
    "type": "Grotte",
    "duree": "3h",
    "conseil": "Réservez guide à l'avance. Lampes frontales fournies. Vêtements pouvant être mouillés.",
    "acces": "70 km au nord, excursion organisée recommandée",
    "horaires": "Visites guidées 9h et 14h (marée basse)",
    "id": 704,
    "image": "images/placeholder-spot.jpg",
    "siteWeb": "https://www.google.com/maps/search/Grotte+des+Pirates+d'Andovoranto+Toamasina"
  },
  {
    "nom": "Jardin Secret de Madame Rabe",
    "ville": "Toamasina",
    "description": "Jardin privé tropical luxuriant tenu par botaniste passionnée. Collection rare d'orchidées endémiques, plantes médicinales malgaches, arbres fruitiers exotiques. Visite intime avec explications détaillées. Oasis de verdure cachée en pleine ville. Sur réservation uniquement.",
    "tags": [
      "toamasina",
      "spots",
      "budget_2",
    ...
    "type": "Jardin Privé",
    "duree": "2h",
    "conseil": "Réservation obligatoire 48h avant par téléphone. Madame Rabe parle français couramment.",
    "acces": "Quartier résidentiel de Tamatave, adresse exacte donnée à la réservation",
    "horaires": "Mer et Sam 10h-12h (sur réservation)",
    "id": 705,
    "image": "images/placeholder-spot.jpg",
    "siteWeb": "https://www.google.com/maps/search/Jardin+Secret+de+Madame+Rabe+Toamasina"
  }
];
